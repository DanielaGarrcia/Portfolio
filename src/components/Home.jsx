...
const Home = () => {
  const downloadPDF = () => {
    const pdfUrl = `${process.env.PUBLIC_URL}/Cv_Daniela_Ponce.pdf`; // Ruta relativa al PDF en tu carpeta de assets
    const link = document.createElement('a');
    link.href = pdfUrl;
    link.download = 'CV_Daniela_Ponce.pdf'; // Nombre que se le dará al archivo descargado
        ...
        <footer className='footer'>
          <div className="card_f">
            <div className="contact shadow">
              ...
              <p className="contact_data">+52 33 2909 6961</p>
            </div>
            <div className="contact shadow">
              <i class="fa-solid fa-envelope"></i>
              <p className="contact_data">Danigarcia.0607@outlook.com</p>
            </div>
            {/* <div className="contact shadow">
