    ...
    <section className='screen_size center'>
        ...
        <div className='project row'>
            ...
            <div className="card_project">
                <p className="title">Multi-platform developer</p>
                <div className="flex margin"> 
                    <p className="rol">LMS Web Page</p>
                </div>
                <p className="description">Development of educational platforms with responsive web design, ensuring an optimal user experience across all devices. I ensure accessibility and functionality on computers, tablets, and smartphones, allowing students to access classes, materials, and activities seamlessly from anywhere.</p>
            </div>
        </div>
        ...
        <div className='project row reverse_col'>
            <div className="card_project c_r">
                ...
                <p className="description">The project of a website for a school aims to provide a digital platform that facilitates communication, access to educational resources, and administrative management for students, parents, and faculty.</p>
            </div>
            <div className='mockup'>
        ...
        <div className='project row'>
            ...
            <div className="card_project">
                <p className="title">StarTech</p>
                <div className="flex margin">
                    <p className="rol">Mobile App</p>
                </div>
                <p className="description">Mobile application developed for the efficient management of parking lots in shopping centers, <span className="gradient_text">integrating IoT technologies</span>to provide a smoother and more automated experience.</p>
            </div>
        </div>

        <div className='project row reverse_col'>
            <div className="card_project c_r">
                <p className="title">Resources Page</p>
                <div className="flex margin">
                    <p className="rol">Wordpress Page</p>
                </div>
                <p className="description">Contributed to an Air Force project by developing a dedicated resource page as part of an initiative to enhance their marketing websites. The goal was to <span className="gradient_text">empower the team with the autonomy</span> to independently develop and integrate their own resources..</p>
            </div>
            <div className='mockup '>
